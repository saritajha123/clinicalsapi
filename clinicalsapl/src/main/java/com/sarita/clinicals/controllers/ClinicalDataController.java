...
import com.sarita.clinicals.dto.ClinicalDataRequest;
import com.sarita.clinicals.model.ClinicalData;
import com.sarita.clinicals.model.Patient;
import com.sarita.clinicals.repos.ClinicalDataRepository;
...
public class ClinicalDataController {
	...
	public ClinicalData saveClinicalData(@RequestBody ClinicalDataRequest request) {
		 Patient patient = patientRepository.findById(Integer.valueOf(request.getPatientId())).get() ;
	 ...
	 public List< ClinicalData> getClinicalData(@PathVariable("patientId")int patientId,
			 @PathVariable("patientId")String componentName){
		 ...
		 clinicalData = clinicalDataRepository.findByPatientIdAndComponentName(patientId,componentName);
		 clinicalData = clinicalDataRepository.findAllByPatientId(patientId);
